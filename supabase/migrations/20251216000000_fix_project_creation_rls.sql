...
-- Add policy to allow creators to add themselves as owner during project creation
-- This policy allows inserting if you're the creator of the project
CREATE POLICY IF NOT EXISTS "Creators can add themselves as owner"
